...
public class SummaryListAdapter extends BaseAdapter {
    ...
    protected ArrayList<Student> mStudentArrayList;

    public SummaryListAdapter(ArrayList<Student> studentArrayList) {
    ...
    */
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
        View entry = inflater.inflate(R.layout.summary_entry, viewGroup, false);
        Student pObj = mStudentArrayList.get(i);
        ((TextView)entry.findViewById(R.id.s_first_name_id)).setText(pObj.getFirstName());
        ((TextView)entry.findViewById(R.id.s_last_name_id)).setText(pObj.getLastName());
        return entry;
    }
}
